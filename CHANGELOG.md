...
### Features
- **profile:** View another person's profile (#220)

## [12.33.0] - 2026-08-19

### Features
- **cli-session:** Per-user dign<->dig-app IPC session (dig_ecosystem#908) (#215)
...
### Features
- **wallet:** Paste, summarize and take Chia offers (#199)- **wallet:** Send $DIG (CAT) from the wallet tab (#197)

## [12.20.0] - 2026-08-17

### Features
- **wallet:** A two-way activity list joining arrivals with the outbound spend log (#196)

## [12.19.0] - 2026-08-17

### Features
- **profile:** Paged profile browser, per-profile edit modal and collapsible fieldsets (#195)

## [12.18.0] - 2026-08-17

### Bug Fixes
- **profile:** Durable profile creation and honest publish retry (#194)

## [12.17.0] - 2026-08-17

### Bug Fixes
- **icon:** Embed the DIG Mark so notifications stop showing a generic file icon (#193)
...
### Features
- **profile:** Drive a whole-profile creation from confirmed on-chain evidence (#177)

## [12.3.0] - 2026-08-15

### Features
- **wallet:** Make the send path stop claiming what it does not know (#168)
